...
import develop.app.replicationdatasource.routingdatasource.ReplicationRoutingDataSource;
...
public class WithRoutingDataSourceConfig {
    ...
    public DataSource writeDataSource() {
        EmbeddedDatabaseBuilder builder = new EmbeddedDatabaseBuilder()
                ...
                .addScript("classpath:/database/writedb.sql");
    ...
    public DataSource readDataSource() {
        EmbeddedDatabaseBuilder builder = new EmbeddedDatabaseBuilder()
                ...
                .setType(EmbeddedDatabaseType.H2)
                .setScriptEncoding("UTF-8")
                .addScript("classpath:/database/readdb.sql");
        return builder.build();
    }
